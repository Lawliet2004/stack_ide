...
> - **Phase 4/5:** remaining feature slices (git per-hunk, didSave policy ask, DAP UX, full SSH, marketplace, notebooks, devcontainers, extra grammars, snippet tab-stops) and doc/CI cleanup are still open. `didSave` is deliberately unchanged pending approval.
