...
impl SymbolKind {
    ...
    pub fn icon_color(&self, palette: &crate::theme::ThemePalette) -> egui::Color32 {
        match self {
            ...
            SymbolKind::Trait => palette.syntax.type_name,
            SymbolKind::Impl => palette.syntax.macro_name,
            SymbolKind::Constant => palette.semantic.completion_field,
            SymbolKind::Module => palette.semantic.completion_keyword,
