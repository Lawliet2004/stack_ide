//! Portable workspace identity, trust, and exclude matching.
//!
//! These types deliberately do not depend on UI state. The application can
//! migrate individual subsystems from the legacy single-root model without
//! duplicating root ownership or trust decisions.
